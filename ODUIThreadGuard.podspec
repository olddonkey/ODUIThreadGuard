#
#  Be sure to run `pod spec lint ODUIThreadGuard.podspec' to ensure this is a
...
ODUIThreadGuard is a guard to help me check if you make UI changes not in main thread. Highly recommand you add this file to your project as early as possible.
  ...
  s.source       = { :git => "https://github.com/olddonkey/ODUIThreadGuard.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "ODUIThreadGuard/ODUIThreadGuard.swift"
